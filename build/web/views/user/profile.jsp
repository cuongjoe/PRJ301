...
<html>
    ...
    <body class="bg-emerald-600" >
        <div class="h-[10rem] bg-green-900 w-full relative bg-sky-200/50">
            <div class="absolute top-[100%] left-[50%] -translate-y-2/4 -translate-x-2/4">
                <div class="rounded-full border-solid border-4 border-blue-400 w-[200px] h-[200px] overflow-hidden" >
                    <img src='<%=user.getAvatar() != null ? "images/user/" + user.getAvatar() : "images/logo_seafood.png"%>' id="avatar" class="w-full h-full align-middle"/>
                    ...
                    <form enctype="multipart/form-data" action="/cuongproject/profile/editAvatar" id="form-avatar" method="POST">
        ...
        <div class="mt-[160px] max-w-lg mx-auto">
            <form action="/cuongproject/profile" method="post" id="form-profile-edit">
                ...
                <div class="mb-6 flex items-center">
                    <div class="flex items-center">
                        <input id="male" type="radio" name="gender" value="male" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="country-option-1" aria-describedby="country-option-1" >
        ...
        <script>
            ...
            $.ajax({
            method: "POST",
                    url: "/cuongproject/profile/editAvatar",
