    ...
    <body class="bg-emerald-600">
        <div class="flex">
            ...
            <div class="w-full px-20 py-5">
                ...
                <div class="mb-6">
                    <a href="/cuongproject/admin/state/add" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300">Add state</a>
                </div>
                <div class="w-full grid col-start-1 col-end-7 ">
                    <c:forEach items="${states}" var="state">
                        <div class="min-w-md bg-white rounded-lg border border-gray-200 shadow-md py-5 px-5 mb-5 p-0">
                            <div class="flex flex-col items-center pb-5">
                                ...
                                <div class="flex mt-4 space-x-3">
                                    <a href="/cuongproject/admin/state/edit?id=${state.getId()}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300">Edit</a>
                                    <a href="/cuongproject/admin/state/delete?id=${state.getId()}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">Delete</a>
                                </div>
                            </div>
                        </div>
                    </c:forEach>
