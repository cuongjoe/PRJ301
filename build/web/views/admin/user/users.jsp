...
<!--                    <nav class="flex" aria-label="Breadcrumb">
                ...
                <div class="flex  w-full grid col-start-1 col-end-7">
                    <div class="overflow-x-auto shadow-md sm:rounded-lg">
                        <div class="inline-block min-w-full align-middle">
                            <div class="p-4">
                                <label for="table-search" class="sr-only">Search</label>
                                <form action="/cuongproject/admin/users" method="GET">
...
<!--                                                <td class="p-4 w-4">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap">
                                                    <div class="rounded-full w-7 h-7 overflow-hidden">
                                                        <c:if test="${user.getAvatar()!=null}">
                                                            <img class="w-full h-full" src="/images/user/${user.getAvatar()}"/>
                                                        </c:if>
                                                        <c:if test="${user.getAvatar()==null}">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-center whitespace-nowrap">
                                                    <a href="/cuongproject/admin/users/edit?id=${user.getId()}" class="text-blue-600 hover:underline">Edit</a>
                                                    <a href="/cuongproject/admin/users/delete?id=${user.getId()}" class="ml-3 text-red-600 hover:underline">Delete</button>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    </tbody>
