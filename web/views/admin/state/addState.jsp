    ...
    <body class="bg-emerald-600">
        <div class="flex">
            ...
            <div class="w-full px-10 py-5">
                <div class="mb-6">
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="inline-flex items-center text-xl">
                                <a href="/cuongproject/admin/state" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900">
                ...
                <div class="flex justify-center items-center" style="height: 80vh">
                    <form action="/cuongproject/admin/state/add" style="width: 500px" id="form-state-add">
        ...
        <script>
            $("#form-state-add").on('submit', (e) => {
                ...
                $.ajax({
                    method: "POST",
                    url: "/cuongproject/admin/state/add",
                    data: data,
                }).done(function (data) {
                    if (data?.detailMessage) {
                        ...
                        location.pathname = "/cuongproject/admin/state";
                    }
                })
            })
        </script>
