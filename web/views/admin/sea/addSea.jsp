...
<html>
    ...
    <body class="bg-emerald-600">
                ...
                <div class="mb-6">
                    <nav class="flex" aria-label="Breadcrumb">
                        <ol class="inline-flex items-center space-x-1 md:space-x-3">
                            ...
                            <li class="inline-flex items-center text-xl">
                                <a href="/admin/seas" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-gray-900">
                    ...
                    <div class="flex w-full">
                        <div>
                            <div class="flex justify-center items-center">
                                <form action="/admin/seas/add" style="min-width: 500px" id="form-sea-add">
        ...
        <script>
           ...
           $("#form-sea-add").on("submit", function(e){
               e.preventDefault();
               const new_data = {
               ...
               $.ajax({
                    ...
                    data: new FormData(document.getElementById("form-sea-add")),
                    cache: false,
                    contentType: false,
                    processData: false,
                }).done(function (data) {
