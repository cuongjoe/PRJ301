...
public class AddCategoryController extends BaseAuthAdminController {
    ...
    protected void processPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int groupId = validate.fieldInt(groupIdString, "Error get field group id");// groupidString sau khi parse
            CategoryDBContext categoryDB = new CategoryDBContext();
            Category category = new Category();
            category.setName(name);
            category.setGroupId(groupId);// sau đó truyền vào đẻ set
            // insert
            categoryDB.insert(category);// sau đí insert vào
